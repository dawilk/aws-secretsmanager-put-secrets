 ...
 */
export async function createSecret(client: SecretsManagerClient, secretId: string, secretValue: string): Promise<{ arn: string; name: string }> {
    try {
 ...
 */
export async function describeSecret(client: SecretsManagerClient, secretId: string): Promise<{ arn: string; tags?: Record<string, string> }> {
 ...
 */
export function mergeTags(userTags: Record<string, string>, actionTag: { key: string; value: string }): Record<string, string> {
 ...
 */
export function tagsNeedUpdate(current: Record<string, string>, desired: Record<string, string>): boolean {
 ...
 */
export async function putSecretValue(client: SecretsManagerClient, secretId: string, secretValue: string): Promise<void> {
 ...
 */
export async function tagResource(client: SecretsManagerClient, secretId: string, tags: Record<string, string>): Promise<void> {
 ...
 */
export async function putSecret(client: SecretsManagerClient, inputs: PutSecretInputs): Promise<void> {
