...
const secretId = process.env.PUT_SECRET_TEST_ID || 'PutSecretsIntegrationTest/BasicSecret';
const expectedValue = process.env.PUT_SECRET_TEST_VALUE || 'integration-test-basic-value';
