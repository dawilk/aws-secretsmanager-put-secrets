...
const secretId = process.env.PUT_SECRET_JSON_TEST_ID || 'PutSecretsIntegrationTest/JsonSecret';
const expectedJson = process.env.PUT_SECRET_JSON_TEST_VALUE || '{"api_user":"user","api_key":"key","config":{"active":"true"}}';
